#pragma checksum "C:\Users\justm\source\repos\splitview\Lab splitview\Lab splitview\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "EAC3B54E0DB186E45E4844853D5A85BD"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Lab_splitview
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Lab_splitview.Models.NewsItem dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::Lab_splitview.Models.NewsItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Lab_splitview.Models.NewsItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::Lab_splitview.Models.NewsItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::Lab_splitview.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::Lab_splitview.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::Lab_splitview.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_NewsItems(global::System.Collections.ObjectModel.ObservableCollection<global::Lab_splitview.Models.NewsItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
